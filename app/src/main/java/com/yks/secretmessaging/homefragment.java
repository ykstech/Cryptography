...
//                requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container_view, new  operationfragment()).setReorderingAllowed(true).addToBackStack("Stack").commit();
