package com.yks.secretmessaging;
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((Button) view.findViewById(R.id.button_key)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              if (difflehellman.this.prime_number_1.getText().toString().equals("") || difflehellman.this.prime_number_2.getText().toString().equals("") || difflehellman.this.secret_SENDER.getText().toString().equals("") || difflehellman.this.secret_RECEIVER.getText().toString().equals("")) {
                    Toast.makeText(difflehellman.this.getContext(), "Please Enter Appropriate Value", Toast.LENGTH_SHORT).show();
                    return;
                }
                BigInteger valueOf = BigInteger.valueOf(Long.valueOf(difflehellman.this.prime_number_1.getText().toString()).longValue());
                double doubleValue = Double.valueOf(difflehellman.this.prime_number_2.getText().toString()).doubleValue();
                double doubleValue2 = Double.valueOf(difflehellman.this.secret_SENDER.getText().toString()).doubleValue();
                double doubleValue3 = Double.valueOf(difflehellman.this.secret_RECEIVER.getText().toString()).doubleValue();

                BigInteger power = difflehellman.this.power(doubleValue, doubleValue2, valueOf);
                BigInteger power2 = difflehellman.this.power(difflehellman.this.power(doubleValue, doubleValue3, valueOf).doubleValue(), doubleValue2, valueOf);
